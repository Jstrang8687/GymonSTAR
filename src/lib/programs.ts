...
export const PROGRAM_INFO: Record<ProgramType, ProgramInfo> = {
  UPPER_LOWER: {
    ...
    defaultSchedule: [
      ["CHEST", "LATS", "SIDE_DELTS", "FRONT_DELTS", "REAR_DELTS", "BICEPS", "TRICEPS"],
      ["OUTER_QUADS", "HAMSTRINGS", "GLUTE_MAX", "CALVES_GASTROC", "UPPER_ABS"],
      ["CHEST", "LATS", "SIDE_DELTS", "FRONT_DELTS", "REAR_DELTS", "BICEPS", "TRICEPS"],
      ["OUTER_QUADS", "HAMSTRINGS", "GLUTE_MAX", "CALVES_GASTROC", "CARDIO"],
    ],
  },
  BRO_SPLIT: {
    label: "Bro Split",
    ...
    defaultSchedule: [
      ["CHEST", "FRONT_DELTS", "SERRATUS"],
      ["LATS", "UPPER_TRAPS", "LOWER_TRAPS", "RHOMBOIDS", "LOWER_BACK"],
      ["OUTER_QUADS", "INNER_QUADS", "HAMSTRINGS", "GLUTE_MAX", "CALVES_GASTROC"],
      ["BICEPS", "TRICEPS", "FOREARM_FLEXORS"],
      ["CARDIO", "UPPER_ABS", "OBLIQUES"],
    ],
  },
  PUSH_PULL_LEGS: {
    ...
    defaultSchedule: [
      ...
      ["LATS", "UPPER_TRAPS", "REAR_DELTS", "BICEPS"],
      ["OUTER_QUADS", "HAMSTRINGS", "GLUTE_MAX", "CALVES_GASTROC", "UPPER_ABS"],
      ["CHEST", "FRONT_DELTS", "SIDE_DELTS", "TRICEPS"],
      ["LATS", "UPPER_TRAPS", "REAR_DELTS", "BICEPS"],
      ["OUTER_QUADS", "HAMSTRINGS", "GLUTE_MAX", "CARDIO"],
    ],
  },
  CUSTOM: {
    label: "Custom Build",
    ...
    defaultSchedule: [
      ["CHEST"],
      ["LATS"],
      ["OUTER_QUADS", "HAMSTRINGS", "GLUTE_MAX"],
      ["SIDE_DELTS", "UPPER_ABS"],
      ["BICEPS", "TRICEPS"],
      ["CARDIO"],
      [],
    ],
