...
export function DeleteMyAccountForm({ email }: { email: string }) {
  ...
  return (
    <div className="rounded-lg border border-red-500/40 bg-red-500/5 p-4">
      <p className="text-sm font-bold text-red-300">This permanently deletes your account and all your data.</p>
      <p className="mt-1 text-xs text-slate-400">
        Every monSTAR, workout log, and proof file you&apos;ve uploaded is gone for good. This cannot be undone.
      </p>
